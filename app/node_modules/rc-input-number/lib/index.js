...
function noop() {} /* eslint-disable react/prop-types */
...
var InputNumber = function (_React$Component) {
  ...
  InputNumber.prototype.render = function render() {
    ...
    var _props3 = this.props,
        ...
        name = _props3.name,
        rest = (0, _objectWithoutProperties3['default'])(_props3, ['prefixCls', 'disabled', 'readOnly', 'useTouch', 'autoComplete', 'upHandler', 'downHandler', 'className', 'max', 'min', 'style', 'title', 'onMouseEnter', 'onMouseLeave', 'onMouseOver', 'onMouseOut', 'required', 'onClick', 'tabIndex', 'type', 'placeholder', 'id', 'inputMode', 'pattern', 'step', 'maxLength', 'autoFocus', 'name']);
    var _state2 = this.state,
        value = _state2.value,
        focused = _state2.focused;

    var classes = (0, _classnames2['default'])(prefixCls, (_classNames = {}, _classNames[className] = !!className, _classNames[prefixCls + '-disabled'] = disabled, _classNames[prefixCls + '-focused'] = focused, _classNames));
    ...
    var upClassName = (0, _classnames2['default'])(prefixCls + '-handler', prefixCls + '-handler-up', (_classNames2 = {}, _classNames2[prefixCls + '-handler-up-disabled'] = isUpDisabled, _classNames2));
    var downClassName = (0, _classnames2['default'])(prefixCls + '-handler', prefixCls + '-handler-down', (_classNames3 = {}, _classNames3[prefixCls + '-handler-down-disabled'] = isDownDisabled, _classNames3));
